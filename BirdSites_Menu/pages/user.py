...
records = get_nearby_observations('bqrqjm1r32an', 38.05, -122.94, dist=10, back=7)    
#records = get_nearby_observations('bqrqjm1r32an', 39.885866, -75.262356, dist=10, back=7)
st.write(records)
